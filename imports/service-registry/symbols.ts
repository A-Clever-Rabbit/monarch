...
export const registry = {
	...
	"application/dto/permissions/publication": Symbol.for("application/dto/permissions/publication"),
	"infrastructure/date/default-provider": Symbol.for("infrastructure/date/default-provider"),
} as const
